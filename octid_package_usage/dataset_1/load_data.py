...
base_dir = "/home/lingfeng/Downloads/tumor_dataset/LC25000/lung_colon_image_set/lung_image_sets"
...
print("normal_dir length:", len(os.listdir(normal_dir))) # 
print("lung_aca_dir length:", len(os.listdir(lung_aca_dir))) # 
print("lung_scc_dir length:", len(os.listdir(lung_scc_dir))) # 
...
def get_image(img_path, save_path):
    ...
    im.save(os.path.join(save_path, img_path.split('/')[-1]), "JPEG")
